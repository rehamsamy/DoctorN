...
public class UserRatesAdapter extends RecyclerView.Adapter<UserRatesAdapter.Holder> {
    Context mContext;
    ...
    public UserRatesAdapter(Context mContext,OnItemClickInterface onItemClickInterface,List<ReviewsItem> reviewsItems,String x) {
